...
def signup():
    ...
    def database():
        ...
        if conn.commit():
                Label(winsignup, text="REGISTER", fg = "light green", font=("Calibri", 13,"bold")).pack()
          
        else:
                messagebox.showerror("Error" , "allready exist", parent = winsignup)
...
#________________winsignup_____________	
